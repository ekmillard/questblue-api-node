...
import { APIUserAbortError } from 'questblue';
import { Headers } from 'questblue/core';
...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['QUESTBLUE_BASE_URL'] = undefined;
    });
    ...
    test('env variable', () => {
      process.env['QUESTBLUE_BASE_URL'] = 'https://example.com/from_env';
      const client = new Questblue({
        username: 'My Username',
        password: 'My Password',
        securityKey: 'My Security Key',
    ...
    test('empty env variable', () => {
      process.env['QUESTBLUE_BASE_URL'] = ''; // empty
      const client = new Questblue({
        username: 'My Username',
        password: 'My Password',
        securityKey: 'My Security Key',
      });
      expect(client.baseURL).toEqual('https://api.questblue.com');
    });

    test('blank env variable', () => {
      process.env['QUESTBLUE_BASE_URL'] = '  '; // blank
      const client = new Questblue({
        username: 'My Username',
        password: 'My Password',
        securityKey: 'My Security Key',
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['QUESTBLUE_USERNAME'] = 'My Username';
    process.env['QUESTBLUE_PASSWORD'] = 'My Password';
    process.env['QUESTBLUE_API_KEY'] = 'My Security Key';
    const client = new Questblue();
    expect(client.username).toBe('My Username');
    expect(client.password).toBe('My Password');
    expect(client.securityKey).toBe('My Security Key');
  });

  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['QUESTBLUE_USERNAME'] = 'another My Username';
    process.env['QUESTBLUE_PASSWORD'] = 'another My Password';
    process.env['QUESTBLUE_API_KEY'] = 'another My Security Key';
    const client = new Questblue({
      username: 'My Username',
      password: 'My Password',
      securityKey: 'My Security Key',
